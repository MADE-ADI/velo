...
let auth = { type: 'key', clientKey: "YXV0aDB8Njg3N2FlY2I5ZGVmYjJmMDliODdjYzg3OmpTUE1Da09VRlliYV85WEdseEVqRw==" };

// 3. Paste the `data-agent-id' in the 'agentId' variable
let agentId = "v2_agt_2I34jePL"
...
// Expose handleAction globally for webSpeechAPI.js
